...
しかし、現代のフロントエンド事情に合わせて「Three.jsをReactを併用したい」というニーズに特化したライブラリ、[react-three-fiber](https://github.com/pmndrs/react-three-fiber)というものがあります。
...
私は特にThree.jsにすごく精通しているというわけではなく、ごく基礎的な機能がわかる程度です。

そのため、本記事は「Reactはわかるけど、3Dはほとんど扱ったことがない」方向けの解説となります。
...
以上のように、モデルやシーンをJSXライクな書き方でコンポーネントとして分割しながら書くことができるので、ある程度Reactに慣れている方にとっては可読性の高いコードで3Dを制御できます！最高ですね。
...
ここからは少しだけ高度な内容になります。Blender等の3Dモデリングツールの利用経験がない方は、スキップしてしまっても大丈夫です！
...
スザンヌくんのメッシュを作成したら、「ファイル」→「エクスポート」→「glTF 2.0」を選択します。
